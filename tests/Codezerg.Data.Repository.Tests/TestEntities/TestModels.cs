...
// Entity with InMemory attribute
...
// Entity with Database attribute
[DatabaseRepository(
...
// Entity with Cached attribute and performance settings
[CachedRepository(
    PreloadCache = false,
    DatabaseName = "CacheTest"
)]
[RepositoryPerformance(
    ConnectionPoolSize = 20,
    CommandTimeout = 10,
    EnableQueryCache = true,
    QueryCacheDurationSeconds = 120
)]
